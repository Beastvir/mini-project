...
import { X, Award, User, Globe } from 'lucide-react';
import { useState } from 'react';
import { MenuItem, Priority } from '../types/cafe';
...
export function OrderModal({ item, isOpen, onClose, onConfirm }: OrderModalProps) {
        ...
        <>
          ...
          >
            ...
            >
              ...
              <div className="p-6">
                <h3 className="mb-2 text-center" style={{ color: '#6B4F4F' }}>{item.name}</h3>
